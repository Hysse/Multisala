	...
	public static void main(String[] args) {
		...
		try
		{
			if(!file.exists())
			{
					...
					Film film2 = new Film("La città incantata","Film d'animazione di Miazaki che parla di una città incantata e di una ragazzina che ci si ritrova per errore",80, 2);
