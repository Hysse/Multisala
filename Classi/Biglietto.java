...
/**
 * Rappresenta il concetto di Biglietto per un determinato spettacolo e per un
 * posto, con associato un prezzo. Un biglietto ha anche un stato che ne indica
 * l'avvenuto acquisto.
 *
 */
public class Biglietto implements Cloneable, Serializable {
	...
	/**
	 * Metodo costruttore del biglietto, imposta il prezzo del biglietto al prezzo
	 * dello spettacolo
	 * 
	 ...
	 * @param acquistato Variabile booleana che indica se un biglietto è una
	 *                   prenotazione oppure no.
	 */
	 ...
	 * 
	 * @return Restituisce true se il biglietto è una prenotazione ed è quindi non
	 *         "acquistato", false altrimenti.
	 */
	...
	/**
	 * Metodo modificatore del tipo di biglietto. Cambia lo stato del biglietto in
	 * "acquistato".
	 */
	...
	/**
	 * Metodo per visualizzare le informazioni formattate di un biglietto
	 * 
	 * @return Stringa con le informzioni
	 */
	public String displayBiglietto() {
		return "Spettacolo : " + spettacolo.displayContent() + " Posto : " + lettera + " " + numero
				+ " Prezzo pagato : " + prezzo;
	}
	...
	public String toString() {
		return getClass().getName() + "[Spettacolo = " + spettacolo + " Lettera = " + lettera + "Numero = " + numero
				+ " Acquistato = " + acquistato + " Prezzo = " + prezzo + "]";
	}
	...
	/**
	 * Metodo di confronto dell'uguaglianza tra un Oggetto obj ed il Biglietto
	 * chiamante.
	 * 
	 * @param obj L'Oggetto con cui confrontare il Biglietto chiamante.
	 * @return Restituisce true se l'Oggetto obj ha lo stesso stato del Biglietto
	...
	public boolean equals(Object obj) {
		...
		return other.acquistato == acquistato && other.numero == numero && other.lettera == lettera
				&& other.spettacolo.equals(spettacolo) && other.prezzo == prezzo;
	}
