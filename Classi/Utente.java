...
/**
 * Questa classe viene utilizzata per salvare username e password relativo ad un
 * utente. Inoltre ha un ID progressivo.
 */
...
public class Utente implements Serializable, Cloneable {
	...
	public String toString() {
		return getClass().getSimpleName() + "[Username = " + this.username + ", Password = " + this.password
				+ ", isGestore = " + isGestore + "]";
	}
